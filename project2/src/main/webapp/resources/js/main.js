...
function loginValidate() {
    ...
    // name은 같은 이름이 여러개 있을 수 있지만 querySelector는 첫번째만 가져온다
...
selectEmail.addEventListener("click", (e)=>{
    ...
    $.ajax({
        ...
        type: "Post",
        dataType: "JSON", // 응답 데이터 형식이 JSON이다 -> 자동으로 JS 객체로 변환
        success: (member)=>{
            console.log(member);
            ...
            // 방법 2) dataType : "JSON" 추가 (type과 success 사이)
